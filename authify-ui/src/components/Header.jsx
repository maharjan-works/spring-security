...
const Header = () => {
    ...
    return (
        <div className="text-center d-flex flex-column align-items-center justify-content-center py-5 px-3" style={{minHeight: "80vh"}}>
            <img className="img-fluid mb-4" src= {assets.header} alt="header" width={400} />

            <h5 className="fw-semibold">
                Hey {userData ? userData.firstName + ' ' + userData.lastName : 'Developer'} <span role="img" aria-label={"wave"}>👋</span>
            </h5>
